...
access = "WX84pZEWXv11BRmWRqj3hfl6xyxQWYty0uSJYR05"
secret = "xhcrm3uvqNcxDNBbTyb7T4joUUiEFKj7K6nl0WD6"
...
while True:
    try:
        ...
        #시간에 따라서 if문
        if start_time + datetime.timedelta(seconds=10) < now < end_time: # 09시로 하면 무한루프가 되니까
